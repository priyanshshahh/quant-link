...
See [Tables](/src/raw-data-output/tables.md), [Reducers](/functions/reducers), and [Column Types](/tables/column-types) for full server-side documentation. The rest of this page covers the **client SDK** (connections, subscriptions, callbacks).
